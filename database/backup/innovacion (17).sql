...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2024 a las 02:43:39
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_actualizar_comentario` (IN `_idcomentario` INT, IN `_comentario` TEXT, IN `_valoracion` SMALLINT)   BEGIN
    UPDATE comentarios
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_buscar_correo_visita` (IN `_email` VARCHAR(90))   BEGIN
    SELECT *
    FROM visitas
    WHERE email = _email;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_eliminar_comentario` (IN `_idcomentario` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_obtener_comentarios` ()   BEGIN
	select * from notas;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_obtener_comentarios_id` (IN `_idnegocio` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_obtener_idvisita_por_comentario` (IN `_idcomentario` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_registrar_comentarios` (IN `_idvisita` INT, IN `_idnegocio` INT, IN `_comentarios` TEXT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_registrar_visita` (IN `_email` VARCHAR(100), IN `_name_google` VARCHAR(50), IN `_picture` VARCHAR(200))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_verificar_id` (IN `_email` VARCHAR(90))   BEGIN
    SELECT idvisita
    FROM visitas
    WHERE email = _email;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_verificar_usuario` (IN `_email` VARCHAR(100))   BEGIN
...
INSERT INTO `comentarios` (`idcomentario`, `idvisita`, `idnegocio`, `comentarios`, `valoracion`, `create_at`, `update_at`, `inactive_at`) VALUES
(2, 7, 1, 'alonso p', NULL, '2024-03-18 11:39:14', NULL, NULL),
(31, 8, 1, 'a ver', NULL, '2024-03-18 14:41:18', NULL, NULL),
(32, 7, 1, 'xd', NULL, '2024-03-18 14:42:10', NULL, NULL),
(37, 7, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', NULL, '2024-03-18 16:44:31', NULL, NULL),
(38, 8, 2, 'It\'s difficult to find examples of lorem ipsum in use before Letraset made it popular as a dummy text in the 1960s, although McClintock says he remembers coming across the lorem ipsum passage in a book of old metal type samples. So far he hasn\'t relocated where he once saw the passage, but the popularity of Cicero in the 15th century supports the theory that the filler text has been used for centuries.', NULL, '2024-03-18 17:46:19', NULL, NULL),
(39, 7, 2, 'Hola chamo', NULL, '2024-03-19 01:07:35', NULL, NULL),
(40, 7, 2, 'ee', NULL, '2024-03-19 01:14:55', NULL, NULL),
(41, 7, 2, 'xdd', NULL, '2024-03-19 01:16:44', NULL, NULL),
(42, 8, 2, 'So how did the classical Latin become so incoherent? According to McClintock, a 15th century typesetter likely scrambled part of Cicero\'s De Finibus in order to provide placeholder text to mockup various fonts for a type specimen book.', NULL, '2024-03-19 01:29:39', NULL, NULL);
...
(1, 2, 1, 2, '1111', 'a', 'asda', 'asdasd', '99', 'asd@gmail.com', 'asd', 'asd', 'asd', 'asd', 'asd.com', '5741fc3efa2d08331c1ed003b6c1d8cbe41c77e8.jpg', '5741fc3efa2d08331c1ed003b6c1d8cbe41c77e8.jpg', 'I', '2024-03-16 22:33:41', NULL, NULL),
(2, 1, 1, 5, '55551', 'Chamo', 'pollito', 'maiu', '987', 'miau@gmail.com', 'asd', '855', 'asd', 'xxaxsa', 'miau.com', '5f57cda75c78a02a0afdc09591986f8c7e3fcb8f.jpg', '5f57cda75c78a02a0afdc09591986f8c7e3fcb8f.jpg', 'I', '2024-03-18 12:11:48', NULL, NULL);
...
(1, 1, 4, -13.4191382, -76.1361804, '2024-03-16 19:25:14', NULL, NULL);
...
INSERT INTO `visitas` (`idvisita`, `email`, `name_google`, `picture`, `create_at`, `update_at`, `inactive_at`) VALUES
(7, 'alonsomunoz263@gmail.com', 'Darce Gg', 'https://lh3.googleusercontent.com/a/ACg8ocK4pA-TGizBsFTMktodiLwXCz5YwfsVGUjM9lt2FVCe=s96-c', '2024-03-18 10:57:25', NULL, NULL),
(8, 'alonsoredick@gmail.com', 'Alonso Redick', 'https://lh3.googleusercontent.com/a/ACg8ocJwr61DveYhs0IQ6nTr-PSmvVaR8NLrzdPBI7gFvcRr=s96-c', '2024-03-18 11:44:51', NULL, NULL),
(9, 'yorghetyauri123@gmail.com', 'Yorghet HernandezYeren', 'https://lh3.googleusercontent.com/a/ACg8ocJ9Z5ZP-DkYUWCQIKq3XbmqdCmcPCWfOK_jk9MEwshLlLw=s96-c', '2024-03-18 13:37:53', NULL, NULL);
