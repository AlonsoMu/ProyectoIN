...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-03-2024 a las 04:34:38
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_obtener_comentarios_id` (IN `_idcomentario` INT)   BEGIN
...
(1, 'alonsomunoz263@gmail.com', 'Darce Gg', 'https://lh3.googleusercontent.com/a/ACg8ocK4pA-TGizBsFTMktodiLwXCz5YwfsVGUjM9lt2FVCe=s96-c', '2024-03-16 22:33:55', NULL, NULL);
